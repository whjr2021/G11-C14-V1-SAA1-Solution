...
player3 = Player("Maria", blue_carx, blue_cary)
...
while carryOn:
    ...
    blue_car = player2.image_load("blue_car.png", 80, 130)
    # 2. Display player3 name at location (blue_carx+20, blue_cary+130)
    player3.player_name((blue_carx+20, blue_cary+130))
